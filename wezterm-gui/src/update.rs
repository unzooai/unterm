...
fn get_github_release_info(uri: &str) -> anyhow::Result<Release> {
    ...
    let _res = Request::new(&uri)
        ...
        .header(
            "User-Agent",
            &format!("unterm/unterm-{}", wezterm_version()),
        )
        .send(&mut latest)
...
pub fn get_latest_release_info() -> anyhow::Result<Release> {
    get_github_release_info("https://api.github.com/repos/user/unterm/releases/latest")
}

#[allow(unused)]
pub fn get_nightly_release_info() -> anyhow::Result<Release> {
    get_github_release_info("https://api.github.com/repos/user/unterm/releases/tags/nightly")
}
...
fn set_banner_from_release_info(latest: &Release) {
    ...
    let url = format!("https://github.com/user/unterm/releases#{}", latest.tag_name);
