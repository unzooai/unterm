...
fn status_bar_theme_colors() -> ((u8, u8, u8), (u8, u8, u8), (u8, u8, u8)) {
    match crate::overlay::theme_selector::read_theme_id().as_str() {
        "midnight" => ((0x13, 0x1a, 0x27), (0x3a, 0x49, 0x63), (0xd6, 0xe0, 0xef)),
        "daylight" => ((0xe4, 0xe8, 0xe3), (0x90, 0x9a, 0x91), (0x12, 0x1a, 0x23)),
        "classic" => ((0x1a, 0x1a, 0x1a), (0x55, 0x55, 0x55), (0xe8, 0xe8, 0xe8)),
        "notion-dark" => ((0x20, 0x20, 0x1e), (0x55, 0x53, 0x4c), (0xe4, 0xe2, 0xdc)),
        "notion-light" => ((0xe6, 0xe3, 0xdc), (0x9f, 0x99, 0x8d), (0x1d, 0x1b, 0x17)),
        _ => ((0x18, 0x18, 0x18), (0x46, 0x46, 0x46), (0xdf, 0xdf, 0xdf)),
    }
}
...
fn confirm_banner_theme_colors() -> ((u8, u8, u8), (u8, u8, u8), (u8, u8, u8)) {
    match crate::overlay::theme_selector::read_theme_id().as_str() {
        "midnight" => ((0x3a, 0x1b, 0x27), (0xff, 0x7a, 0x8a), (0xff, 0xe6, 0xdd)),
        "daylight" => ((0xff, 0xd9, 0xd0), (0xac, 0x1f, 0x32), (0x2c, 0x0f, 0x15)),
        "classic" => ((0x3d, 0x1f, 0x18), (0xff, 0x5f, 0x57), (0xff, 0xe2, 0xc2)),
        "notion-dark" => ((0x36, 0x1d, 0x19), (0xff, 0x78, 0x69), (0xff, 0xe6, 0xdc)),
        "notion-light" => ((0xff, 0xdb, 0xd3), (0xa9, 0x28, 0x28), (0x2d, 0x12, 0x10)),
        _ => ((0x36, 0x16, 0x10), (0xff, 0x6b, 0x62), (0xff, 0xdf, 0xc2)),
    }
}
...
fn suggest_bar_theme_colors() -> ((u8, u8, u8), (u8, u8, u8), (u8, u8, u8)) {
    match crate::overlay::theme_selector::read_theme_id().as_str() {
        "midnight" => ((0x1b, 0x27, 0x40), (0x8c, 0xb6, 0xff), (0xe0, 0xeb, 0xff)),
        "daylight" => ((0xff, 0xed, 0xb8), (0x82, 0x55, 0x00), (0x28, 0x1d, 0x05)),
        "classic" => ((0x2a, 0x25, 0x18), (0xf2, 0xc2, 0x3d), (0xff, 0xe5, 0xb0)),
        "notion-dark" => ((0x2d, 0x28, 0x1b), (0xf0, 0xc2, 0x58), (0xff, 0xe3, 0xa6)),
        "notion-light" => ((0xff, 0xec, 0xbd), (0x7a, 0x4f, 0x0d), (0x29, 0x1d, 0x08)),
        _ => ((0x26, 0x21, 0x15), (0xee, 0xcf, 0x70), (0xff, 0xde, 0xa0)),
    }
}
