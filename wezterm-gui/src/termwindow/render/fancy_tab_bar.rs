...
// Windows Terminal style drop-down chevron for the menu button.
const DROPDOWN_BUTTON: &[Poly] = &[Poly {
    path: &[
        PolyCommand::MoveTo(BlockCoord::Frac(1, 5), BlockCoord::Frac(2, 5)),
        PolyCommand::LineTo(BlockCoord::Frac(1, 2), BlockCoord::Frac(3, 5)),
        PolyCommand::LineTo(BlockCoord::Frac(4, 5), BlockCoord::Frac(2, 5)),
    ],
    intensity: BlockAlpha::Full,
    style: PolyStyle::Outline,
}];
