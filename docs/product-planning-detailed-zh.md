...
- benchmark harness，包含 input write、echo、output flood、scrollback paging、viewport scroll、paste、dual-agent、screen-read under flood、focus switch、session create。
