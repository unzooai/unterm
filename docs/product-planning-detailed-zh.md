...
- `capture.scrollback` 的 next-core 语义明确：已支持 styled cell snapshot、配置主题 palette 解析和基础 styled PNG，后续补粗体/斜体字体匹配和 renderer parity。
