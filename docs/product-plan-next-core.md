...
- `NextCoreGlyphTexture`, a dedicated WebGPU glyph texture atlas that validates next-core glyph texture regions and uploads them with `queue.write_texture` before the textured glyph render pass is attached
