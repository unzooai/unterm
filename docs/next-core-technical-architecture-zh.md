...
- `EngineWgpuRenderBackend::prepare_frame_for_viewport` 已把 clip-space upload buffers 与 text-atlas input 合并为同一帧 preparation；WebGPU pane encoder 现在会先生成 combined frame plan 再绘制
