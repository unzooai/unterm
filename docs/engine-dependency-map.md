...
| `cockpit.inbox` | Partial | Agent registry joined with `SessionEngine::list_sessions`; WezTerm adds optional tab/window jump metadata | Needs engine-neutral instance/window location model for cross-engine jumps. |
