...
- next-core terminal status, cursor-position, DEC private cursor-position, text-area-size, and primary/secondary device-attribute query responses, including parameterized DA forms, through the PTY writer in input order
