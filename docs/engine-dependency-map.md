...
| WezTerm-only | 8 | `capture.screen`, `capture.window`, `capture.select`, `capture.scrollback`, `capture.window_scroll`, `instance.set_title`, `instance.focus`, `system.launch_admin` |
