...
- GUI `WebGpuState::next_core_pane_replace_diagnostics` now composes the replace preflight in one WebGPU-side entry point, keeping draw-loop code from manually stitching prepared-frame and glyph-upload diagnostics
