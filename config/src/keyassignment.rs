...
pub enum KeyAssignment {
    ...
    /// Unterm: Copy if there's a selection, otherwise send the key to the terminal.
    /// This matches Windows Terminal's Ctrl+C behavior.
    CopyToOrSendKey(ClipboardCopyDestination),
    CopyTextTo {
        text: String,
