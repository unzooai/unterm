...
pub(in crate::next_core) fn attach_recording_trace(
    ...
    scheduler::attach_recording_trace(pane_id, trace_id)
}
...
pub(in crate::next_core) fn export_recording_markdown(
    ...
    scheduler::export_recording_markdown(pane_id, target_path)
}
