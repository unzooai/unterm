...
pub const THEMES: &[Theme] = &[
    Theme {
        ...
        ansi: [
            srgb(0x1c, 0x1c, 0x1c), srgb(0xff, 0x5f, 0x57), srgb(0x5f, 0xd1, 0x7a), srgb(0xe5, 0xc4, 0x63), srgb(0x5a, 0xa7, 0xff), srgb(0xc6, 0x78, 0xdd), srgb(0x63, 0xcd, 0xb8), srgb(0xd6, 0xd6, 0xd6), srgb(0x73, 0x73, 0x73), srgb(0xff, 0x7b, 0x72), srgb(0x7e, 0xe7, 0x87), srgb(0xf2, 0xd1, 0x6b), srgb(0x79, 0xb8, 0xff), srgb(0xd2, 0xa8, 0xff), srgb(0x82, 0xdf, 0xc9), srgb(0xff, 0xff, 0xff),
        ],
    },
    Theme {
        id: "midnight",
        ...
        ansi: [
            srgb(0x17, 0x1d, 0x2b), srgb(0xff, 0x6b, 0x7a), srgb(0x8b, 0xdc, 0x88), srgb(0xe6, 0xc4, 0x6a), srgb(0x82, 0xaa, 0xff), srgb(0xc9, 0x9c, 0xff), srgb(0x67, 0xcd, 0xb6), srgb(0xcb, 0xd5, 0xe1), srgb(0x66, 0x70, 0x85), srgb(0xff, 0x87, 0x94), srgb(0xa7, 0xec, 0x9f), srgb(0xf0, 0xd3, 0x7a), srgb(0x9c, 0xc0, 0xff), srgb(0xd8, 0xb4, 0xff), srgb(0x8a, 0xe0, 0xcc), srgb(0xff, 0xff, 0xff),
        ],
    },
    Theme {
        id: "daylight",
        ...
        ansi: [
            srgb(0x0b, 0x0f, 0x14), srgb(0xb4, 0x23, 0x35), srgb(0x17, 0x64, 0x3b), srgb(0x7a, 0x52, 0x00), srgb(0x00, 0x5e, 0xa8), srgb(0x65, 0x37, 0xa0), srgb(0x0a, 0x76, 0x69), srgb(0x3f, 0x47, 0x52), srgb(0x60, 0x69, 0x75), srgb(0xcf, 0x33, 0x47), srgb(0x25, 0x82, 0x4d), srgb(0x93, 0x63, 0x00), srgb(0x0a, 0x74, 0xc9), srgb(0x7b, 0x4c, 0xc2), srgb(0x11, 0x8d, 0x7d), srgb(0x02, 0x04, 0x06),
        ],
    },
    Theme {
        id: "classic",
        ...
        ansi: [
            srgb(0x1c, 0x1c, 0x1c), srgb(0xef, 0x44, 0x44), srgb(0x22, 0xc5, 0x5e), srgb(0xea, 0xb3, 0x08), srgb(0x3b, 0x82, 0xf6), srgb(0xa8, 0x55, 0xf7), srgb(0x06, 0xb6, 0xd4), srgb(0xd4, 0xd4, 0xd4), srgb(0x73, 0x73, 0x73), srgb(0xf8, 0x71, 0x71), srgb(0x4a, 0xde, 0x80), srgb(0xfa, 0xcc, 0x15), srgb(0x60, 0xa5, 0xfa), srgb(0xc0, 0x84, 0xfc), srgb(0x22, 0xd3, 0xee), srgb(0xff, 0xff, 0xff),
        ],
    },
    Theme {
        id: "notion-dark",
        ...
        ansi: [
            srgb(0x25, 0x25, 0x25), srgb(0xff, 0x6f, 0x61), srgb(0x4f, 0xb2, 0x86), srgb(0xe7, 0xb8, 0x4f), srgb(0x5a, 0xa7, 0xd6), srgb(0xb0, 0x83, 0xd9), srgb(0x5f, 0xc6, 0xbd), srgb(0xd8, 0xd8, 0xd4), srgb(0x66, 0x63, 0x5d), srgb(0xff, 0x8b, 0x80), srgb(0x6e, 0xd0, 0xa2), srgb(0xf2, 0xcc, 0x6b), srgb(0x7b, 0xc0, 0xe6), srgb(0xc4, 0x9b, 0xe6), srgb(0x7d, 0xe0, 0xd7), srgb(0xff, 0xff, 0xff),
        ],
    },
    Theme {
        id: "notion-light",
        ...
        ansi: [
            srgb(0x1f, 0x1e, 0x1a), srgb(0xb8, 0x32, 0x32), srgb(0x2f, 0x6f, 0x4f), srgb(0x8b, 0x5e, 0x12), srgb(0x1f, 0x6f, 0x9f), srgb(0x73, 0x4a, 0x9b), srgb(0x00, 0x6f, 0x7f), srgb(0x5d, 0x5b, 0x55), srgb(0x4f, 0x4d, 0x47), srgb(0xd5, 0x48, 0x48), srgb(0x3a, 0x8a, 0x60), srgb(0xa8, 0x74, 0x16), srgb(0x2b, 0x82, 0xba), srgb(0x86, 0x5b, 0xb0), srgb(0x00, 0x89, 0x9a), srgb(0x0f, 0x0f, 0x0d),
        ],
    },
];
